...
<body>
  <div class="container">
    <div id="resume-header" class="row">
      ...
      <div class="col">
        <h1><?php echo 'Daniel Granados';?></h1>
        <h2>PHP Developer</h2>
        <ul>
          <li>Mail: nick.inkaweb@mail.com</li>
          <li>Phone: 04143283109</li>
          <li>LinkedIn: www.linkedin.com/in/nick-granados</li>
          <li>Twitter: @Internick2010</li>
        </ul>
      </div>
    </div>
    <div class="row">
